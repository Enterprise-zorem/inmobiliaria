...
class interes
{
    private static $tablename = "interes";
    ...
    {
        $this->pk_interes = $this->con->real_escape_string($name);
    }
    ...
    {
        $query = "SELECT * FROM " . self::$tablename . " ORDER BY pk_interes DESC";
    ...
    {
        $query = "SELECT * FROM " . self::$tablename . " WHERE pk_interes=$this->pk_interes";
        $res = $this->con->query($query);
        mysqli_close($this->con);
        return $res;
    }
    ...
    public function update()
    {
        ...
        $query .= " WHERE pk_interes='$this->pk_interes'";
        $this->con->query($query);
    ...
    {
        $query = "DELETE FROM " . self::$tablename . " WHERE pk_interes=$this->pk_interes";
        $this->con->query($query);
