...
class fase
{
    ...
    {
        $this->pk_fase = $this->con->real_escape_string($name);
    }
    ...
    {
        $query = "SELECT * FROM " . self::$tablename . " ORDER BY pk_fase DESC";
    ...
    {
        $query = "SELECT * FROM " . self::$tablename . " WHERE pk_fase=$this->pk_fase";
        $res = $this->con->query($query);
        mysqli_close($this->con);
        return $res;
    }
    ...
    public function update()
    {
        ...
        $query .= " WHERE pk_fase='$this->pk_fase'";
        $this->con->query($query);
    ...
    {
        $query = "DELETE FROM " . self::$tablename . " WHERE pk_fase=$this->pk_fase";
        $this->con->query($query);
