...
class usuario
{
    ...
    public function insert()
    {
        ...
        $query = "INSERT INTO " . self::$tablename . " ( `nombres`, `dni`, `telefono`, `email`, `password`, `image`, `created_at`, `updated_at`, `is_active`, `fk_rol`)";

        $query .= " VALUES ('$this->nombres','$this->dni','$this->telefono','$this->email','$this->password','$this->image','$this->created_at','$this->updated_at','$this->is_active','$this->fk_rol')";
