...
class transaccion
{
    private static $tablename = "transaccion";

    private $con;

    private $pk_transaccion;
    private $name;
    private $created_at;
    private $updated_at;
    ...
    {
        $query = "SELECT * FROM " . self::$tablename . " ORDER BY pk_transaccion DESC";
    ...
    {
        $query = "SELECT * FROM " . self::$tablename . " WHERE pk_transaccion=$this->pk_transaccion";
        $res = $this->con->query($query);
        mysqli_close($this->con);
        return $res;
    }
    ...
    public function update()
    {
        ...
        $query .= " WHERE pk_transaccion='$this->pk_transaccion'";
        $this->con->query($query);
