...
class estatus
{
    private static $tablename = "estatus";
    ...
    {
        $this->pk_estatus = $this->con->real_escape_string($name);
    }
    ...
    {
        $query = "SELECT * FROM " . self::$tablename . " ORDER BY pk_estatus DESC";
    ...
    {
        $query = "SELECT * FROM " . self::$tablename . " WHERE pk_estatus=$this->pk_estatus";
        $res = $this->con->query($query);
        mysqli_close($this->con);
        return $res;
    }
    ...
    public function update()
    {
        ...
        $query .= " WHERE pk_estatus='$this->pk_estatus'";
        $this->con->query($query);
    ...
    {
        $query = "DELETE FROM " . self::$tablename . " WHERE pk_estatus=$this->pk_estatus";
        $this->con->query($query);
