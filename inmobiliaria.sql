...
INSERT INTO `estatus` (`pk_estatus`, `name`, `created_at`, `updated_at`) VALUES
(2, 'activo', '2021-01-27 15:57:29', '2021-01-27 15:57:29'),
(3, 'inactivo', '2021-01-27 15:57:39', '2021-01-27 15:57:39'),
(4, 'vendido', '2021-01-27 15:57:43', '2021-01-27 15:57:43'),
(5, 'alquilado', '2021-01-27 15:57:50', '2021-01-27 15:57:50'),
(6, 'en evaluación', '2021-01-27 15:58:03', '2021-01-27 15:58:03'),
(7, 'en negociación ', '2021-01-27 15:58:13', '2021-01-27 15:58:13'),
(8, 'reservado', '2021-01-27 15:58:18', '2021-01-27 15:58:18');
...
INSERT INTO `fase` (`pk_fase`, `name`, `created_at`, `updated_at`) VALUES
(6, 'Listo para Habitar', '2021-01-27 16:02:42', '2021-01-27 16:02:42'),
(7, 'Futuro Lanzamiento', '2021-01-27 16:03:30', '2021-01-27 16:03:30'),
(8, 'Pre-Lanzamiento', '2021-01-27 16:03:45', '2021-01-27 16:03:45'),
(9, 'En Construcción ', '2021-01-27 16:04:13', '2021-01-27 16:04:13'),
(10, 'Acabado', '2021-01-27 16:04:23', '2021-01-27 16:04:23'),
(11, 'Entregado', '2021-01-27 16:04:31', '2021-01-27 16:04:31');
...
CREATE TABLE `propiedad` (
  `pk_propiedad` int(11) NOT NULL,
  `name` varchar(50) NOT NULL,
  `descripcion` text DEFAULT NULL,
  `fk_categoria` int(11) DEFAULT NULL,
  `parametros` text DEFAULT NULL,
  `fk_transaccion` int(11) DEFAULT NULL,
  `fk_carateristica` text DEFAULT '[]',
  `fk_interes` text DEFAULT '[]',
  `area_total` double(18,2) DEFAULT NULL,
  `area_construida` double(18,2) DEFAULT NULL,
  `area_util` double(18,2) DEFAULT NULL,
  `fk_provincia` double(18,2) DEFAULT NULL,
  `fk_departamento` double(18,2) DEFAULT NULL,
  `fk_distrito` double(18,2) DEFAULT NULL,
  `manzana` text DEFAULT NULL,
  `lote` text DEFAULT NULL,
  `direccion` text DEFAULT NULL,
  `lat` double(18,2) DEFAULT NULL,
  `lon` double(18,2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `proyecto` (
  ...
  `area_total` double(18,2) DEFAULT NULL,
  `area_construida` double(18,2) DEFAULT NULL,
  `fk_fase` int(11) DEFAULT NULL,
  `fk_caracteristica` text DEFAULT '[]',
...
(2, 'asdasd123', '2021-01-25 22:28:04', '2021-01-26 12:29:24'),
(7, 'lorem123', '2021-01-25 22:54:38', '2021-01-26 12:27:51'),
(18, 'prueba', '2021-01-26 12:05:08', '2021-01-26 12:05:08'),
(22, 'prueba3123', '2021-01-26 12:26:25', '2021-01-26 12:31:23');
...
INSERT INTO `tipo` (`pk_tipo`, `name`, `created_at`, `updated_at`, `parametros`) VALUES
(5, 'departamento', '2021-01-27 15:52:56', '2021-01-27 15:52:56', '[]'),
(6, 'casa', '2021-01-27 15:53:53', '2021-01-27 15:53:53', '[]'),
(7, 'comercial', '2021-01-27 15:54:02', '2021-01-27 15:54:02', '[]'),
(8, 'rural', '2021-01-27 15:54:09', '2021-01-27 15:54:09', '[]'),
(9, 'terreno', '2021-01-27 15:54:17', '2021-01-27 15:54:17', '[]');
...
CREATE TABLE `tipo_contacto` (
  `pk_tipo_contacto` int(11) NOT NULL,
  `name` varchar(50) NOT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `transaccion` (
  `pk_transaccion` int(11) NOT NULL,
  `name` varchar(50) NOT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `transaccion` (`pk_transaccion`, `name`, `created_at`, `updated_at`) VALUES
(4, 'venta', '2021-01-27 15:59:20', '2021-01-27 15:59:20'),
(5, 'lanzamiento', '2021-01-27 15:59:28', '2021-01-27 15:59:28'),
(6, 'temporada', '2021-01-27 15:59:36', '2021-01-27 15:59:36'),
(7, 'alquiler', '2021-01-27 15:59:43', '2021-01-27 15:59:43');
...
INSERT INTO `usuario` (`pk_usuario`, `nombres`, `dni`, `telefono`, `email`, `password`, `image`, `fk_rol`, `created_at`, `updated_at`, `is_active`) VALUES
(1, 'Kevin Arnold Zorem', NULL, NULL, 'elmanhpt@gmail.com', '$2y$10$p8aLJ/pgSc13cgyuHPRkSun7td1QD4ilkqHQCRcDKvbB9GYtzCbNK', NULL, NULL, NULL, NULL, NULL),
(2, 'Kevin Arnold', '', '', 'elmanhptm@gmail.com', '$2y$10$p8aLJ/pgSc13cgyuHPRkSun7td1QD4ilkqHQCRcDKvbB9GYtzCbNK', 'http://192.168.1.29/inmobiliaria/res/perfiles/default.gif', 0, '2021-01-25 19:15:32', '2021-01-25 19:15:32', 0),
(3, 'kevin arnold', '', '', 'asdasda@adasdasd', '$2y$10$OEViqeBtmGszUw2B4cFgQuMErdOMgX3ui4AYU205jwAQ7jjMINirW', 'http://192.168.1.29/inmobiliaria/res/perfiles/default.gif', 0, '2021-01-25 19:59:26', '2021-01-25 19:59:26', 0),
(4, 'juanf', '', '', 'juan@juan.com', '$2y$10$oLTiRKSXtWqyyT92GjjcSuDLtCU4/.kFCMtBnFyJI.yyedvquP1e6', 'http://192.168.1.29/inmobiliria/res/perfiles/default.gif', 0, '2021-01-26 11:30:03', '2021-01-26 11:30:03', 0);
...
(1, 'view/home/', 'vista'),
(2, 'view/login/', 'vista'),
(3, 'action/login/', 'proceso'),
(4, 'view/registro/', 'vista'),
(5, 'action/registro/', 'proceso'),
(6, 'view/404/', 'vista'),
(7, 'action/login/logout', 'proceso'),
(8, 'view/usuarios/', 'vista'),
(9, 'action/usuarios/vistas/insert', 'proceso'),
(10, 'view/roles/', 'vista'),
(11, 'action/roles/vistas/insert', 'proceso'),
(12, 'action/roles/insert', 'proceso'),
(13, 'action/roles/vistas/update', 'proceso'),
(14, 'view/fases/', 'vista'),
(15, 'action/roles/list', 'proceso'),
(16, 'action/roles/delete', 'proceso'),
(17, 'action/fases/', 'proceso'),
(18, 'action/fases/vistas/insert', 'proceso'),
(19, 'action/fases/insert', 'proceso'),
(20, 'action/fases/vistas/list', 'proceso'),
(21, 'action/roles/edit', 'proceso'),
(22, 'action/fases/vistas/update', 'proceso'),
(23, 'action/roles/vistas/list', 'proceso'),
(24, 'action/fases/edit', 'proceso'),
(25, 'action/fases/delete', 'proceso'),
(26, 'view/interes/', 'vista'),
(27, 'view/tipo/', 'vista'),
(28, 'action/tipo/vistas/insert', 'proceso'),
(29, 'action/tipo/insert', 'proceso'),
(30, 'action/tipo/vistas/list', 'proceso'),
(31, 'action/tipo/delete', 'proceso'),
(32, 'action/tipo/vistas/update', 'proceso'),
(33, 'action/tipo/update', 'proceso'),
(34, 'view/estatus/', 'vista'),
(35, 'action/estatus/vistas/insert', 'proceso'),
(36, 'action/estatus/insert', 'proceso'),
(37, 'action/estatus/vistas/list', 'proceso'),
(38, 'action/estatus/vistas/update', 'proceso'),
(39, 'action/estatus/update', 'proceso'),
(40, 'action/interes/vistas/insert', 'proceso'),
(41, 'action/interes/insert', 'proceso'),
(42, 'action/interes/vistas/list', 'proceso'),
(43, 'view/transaccion/', 'vista'),
(44, 'action/transaccion/vistas/insert', 'proceso'),
(45, 'action/transaccion/insert', 'proceso'),
(46, 'action/transaccion/vistas/list', 'proceso'),
(47, 'action/transaccion/delete', 'proceso'),
(48, 'action/transaccion/vistas/update', 'proceso'),
(49, 'action/transaccion/update', 'proceso'),
(50, 'action/interes/vistas/update', 'proceso'),
(51, 'action/interes/edit', 'proceso'),
(52, 'action/interes/delete', 'proceso'),
(53, 'view/categoria/', 'vista'),
(54, 'action/categoria/vistas/insert', 'proceso'),
(55, 'action/categoria/insert', 'proceso'),
(56, 'action/categoria/vistas/list', 'proceso'),
(57, 'action/categoria/delete', 'proceso'),
(58, 'action/categoria/vistas/update', 'proceso'),
(59, 'action/categoria/update', 'proceso'),
(60, 'view/tipo/parametros/', 'vista'),
(61, 'action/tipo/parametros/vistas/insert', 'proceso'),
(62, 'action/tipo/parametros/insert', 'proceso'),
(63, 'action/tipo/parametros/vistas/', 'proceso'),
(64, 'action/tipo/parametros/vistas/list', 'proceso'),
(65, 'action/tipo/parametros/delete', 'proceso'),
(66, 'view/caracteristica/', 'vista'),
(67, 'action/caracteristica/vistas/insert', 'proceso'),
(68, 'action/caracteristica/insert', 'proceso'),
(69, 'action/caracteristica/vistas/list', 'proceso'),
(70, 'action/caracteristica/delete', 'proceso'),
(71, 'action/caracteristica/vistas/update', 'proceso'),
(72, 'action/caracteristica/edit', 'proceso'),
(73, 'action/estatus/delete', 'proceso'),
(74, 'view/proyecto/', 'vista'),
(75, 'action/proyecto/vistas/insert', 'proceso'),
...
ALTER TABLE `caracteristica`
  ADD PRIMARY KEY (`pk_caracteristica`);
...
--
ALTER TABLE `fase`
  ADD PRIMARY KEY (`pk_fase`);

--
-- Indices de la tabla `interes`
--
ALTER TABLE `interes`
  ADD PRIMARY KEY (`pk_interes`);

--
-- Indices de la tabla `propiedad`
--
ALTER TABLE `propiedad`
  ADD PRIMARY KEY (`pk_propiedad`);
...
ALTER TABLE `tipo_contacto`
  ADD PRIMARY KEY (`pk_tipo_contacto`);

--
-- Indices de la tabla `transaccion`
--
ALTER TABLE `transaccion`
  ADD PRIMARY KEY (`pk_transaccion`);
...
--
ALTER TABLE `estatus`
  MODIFY `pk_estatus` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de la tabla `fase`
--
ALTER TABLE `fase`
  MODIFY `pk_fase` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `propiedad`
  MODIFY `pk_propiedad` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `proyecto`
--
ALTER TABLE `proyecto`
  MODIFY `pk_proyecto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `rol`
--
ALTER TABLE `rol`
  MODIFY `pk_rol` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT de la tabla `tipo`
--
ALTER TABLE `tipo`
  MODIFY `pk_tipo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `transaccion`
  MODIFY `pk_transaccion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
