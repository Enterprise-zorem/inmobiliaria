...
{   let dhxWindow = new dhx.Window({width: 550, height: 500, title: "Nuevo Usuario", movable: true, closable: true,resizable: true});
    $.ajax({
        url:RUTA+"process.php/usuarios/vistas/insert/",
        type:'GET',
