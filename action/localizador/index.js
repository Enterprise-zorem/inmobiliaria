 ...
 var apiToken = "pk.eyJ1Ijoiem9yZW0iLCJhIjoiY2tja3N0MjJhMXl1MTJ1bzVycm05ZmhnZyJ9.XQxL7kVaULUYHgezBkq36Q";
 var defaultMap = [-73.62722713581184,-8.532023727518833 ]; //Coordenas para que cargue el mapa por default
...
function getStores(){
    var jsonData= $.ajax({
        url: RUTA+'process.php/localizador/data/',
        dataType: 'json',
        async: false
    }).responseText;
